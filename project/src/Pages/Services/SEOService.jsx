      ...
      >
        ...
        <Typography
          ...
          sx={{
            maxWidth: "55rem",
            mt: 3,
            background: "linear-gradient(to right, #DB09F9, #060318)",
            borderRadius: "1rem",
            p: {xs:2 , md:3},
          }}
        >
        ...
        <Typography
          ...
          sx={{
            maxWidth: "55rem",
            mt: 3,
            background: "linear-gradient(to right,#060318, #DB09F9)",
            borderRadius: "1rem",
            p: {xs:2 , md:3},
          }}
        >
       ...
       <Typography
              ...
              >
               Our Graphic Design service covers aspects such as logo design, branding, website design, marketing collateral creation, and more. We employ a combination of creative thinking, market research, and client collaboration to deliver visually appealing designs that effectively communicate brand messages. Our Designers utilize industry-standard graphic design tools such as Adobe Creative Suite, including software like Photoshop, Illustrator, and InDesign, to ensure professional and high-quality design deliverables.
